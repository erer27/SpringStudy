...
public class SawonController {
	...
	// 내장 객체
	public String sawon_insert_ok3(HttpServletRequest request, int sabun,String name, String dept, String loc, String job, int pay,HttpSession sesison)
	{
		SawonVO vo=new SawonVO();
		vo.setSabun(sabun);
		vo.setPay(pay);
	 ...
	 * 			public void addAttrivute(String key, Objaect obj)
	 * 			{
